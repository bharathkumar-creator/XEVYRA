...
import 'package:xevyra_mobile/main.dart';
...
void main() {
  ...
  testWidgets('XevyraMobileApp mounts and renders shell', (WidgetTester tester) async {
    await tester.pumpWidget(const XevyraMobileApp(initialUrl: 'https://example.com'));
    expect(find.byType(XevyraMobileApp), findsOneWidget);
  });
}
